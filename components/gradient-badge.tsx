...
//   return (
//     <div className="inline-block p-[1px] bg-gradient-to-r from-purple-500/50 via-blue-500/50 to-pink-500/50 rounded-md">
//       <div className="px-3 py-1 bg-background rounded-md">
//         <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-blue-400 to-pink-400 font-mono font-semibold">
//           {title}
//         </span>
//       </div>
//     </div>
